    ...
    return (
        <div className={"d-flex justify-content-center m-5 box-s"}>
            <ButtonGroup variant="contained" aria-label="Basic button group" className="buttonGroup m-5">
                ...
                <Button variant="outlined" onClick={() => dialogModalStates.saveModal.setState(true)}
                        startIcon={<AddIcon/>} className="button">
                    Add
                </Button>
                <Button variant="outlined" onClick={() => dialogModalStates.loadModal.setState(true)}
                        startIcon={<CloudDownloadIcon/>} className="button">
                    Load
                </Button>
            </ButtonGroup>
        </div>
